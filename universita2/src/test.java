	...
	public static void main(String[] args) throws IOException{
		...
		try {			
			do {
				...
				System.out.println("5. Stampa media di tutti i voti di uno studente.");	//ok
				...
				switch(scelta) {
					...
					case 5:
						...
						//Stampa media
						System.out.println("Lo studente ha una media voti di: " +mediaVotiApp +".");
						break;
